...
## Tasks
- [x] **1. Time-slider seek while paused (YouTube).** Slider must be authoritative
...
- [x] **2. Center START overlay (logo-styled).** Large centered brand play mark
...
- [x] **3. Layout control → animated unfolding button.** Single button shows the
...
- [x] **4. Sources animation rebuild.** "Plays from any source" climax: labeled
...
## Done
- implemented + verified + committed + pushed; wrote `.phase13.done`; telegram summary.
