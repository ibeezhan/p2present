...
## Tasks
- [ ] 1. Favicons + meta: favicon.ico + icon PNGs + apple-touch-icon(180) + web
...
- [ ] 2. Brand mark in UI: logo (icon-32/48) as nav/footer brand mark on home,
      app header, docs, host, builder. Drop the old emoji/placeholder favicons.
- [ ] 3. Hero logo + scroll-orbit planets: logo-hero-base.png base + 2 glowing
...
- [ ] 4. Watermark in player: watermark.png as a small tasteful corner mark in
      the /app player, non-overlapping with controls, optional home link.

## Verify
- [ ] `npm test` (units) + `npm run smoke` (headless 390/780/1280, 0 console errs, assets 200)
- [ ] static-only, prefers-reduced-motion respected
- [ ] commit + push each step; write .phase12.done; telegram summary
